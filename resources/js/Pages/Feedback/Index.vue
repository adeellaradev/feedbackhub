  ...
  <AuthenticatedLayout>
    ...
    <div class="py-12">
      <div class="mx-auto space-y-6 max-w-7xl sm:px-6 lg:px-8">
          ...
          <div class="space-y-6">
            ...
            <div class="pb-4 border-b border-gray-200">
              ...
              <p class="mt-1 text-sm text-gray-500">
                {{ feedback.meta?.total || feedback.data.length }} total feedback items
              </p>
            </div> 
        ...
        <div v-if="feedback.links && feedback.links.length > 3" class="p-4 bg-white shadow sm:rounded-lg sm:p-6">
          <div class="flex items-center justify-between">
            <div class="flex justify-between flex-1 sm:hidden"> 
              <Link 
                v-if="feedback.links.find(l => l.label.includes('Previous'))"
              ...
              <Link 
                v-if="feedback.links.find(l => l.label.includes('Next'))"
